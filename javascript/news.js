$(document).ready(function () {
   $.ajax({
      url:
         'https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=65eddf7bd02743019b3e480bbe667a94',
      method: 'GET',
      ...
      for (let i = 0; i < 8; i++) {
         ...
         var newsSource = $("<p class='news-source'>").text(
            'source: ' + newsResponse.articles[i].source.name
         );
         var newsImage = $(
